...
<html lang="en">
  ...
  <body>
	...
	<div class="row">
		<div class="col-md-12" style="padding-top: 10px; padding-left: 40px; padding-bottom: 50px">
			<h3>
				Sistem Penilaian
			</h3>
			<div class="row">
				<div class="col-md-8" style="padding-top: 10px; padding-left: 40px; padding-bottom: 50px">
					<h2>
						Belanja Online
					</h2>
